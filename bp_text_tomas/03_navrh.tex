...
Tato kapitola se zabývá analysou a návrhem aplikace jako celku. Nejprve shrnuje a analysuje požadavky, pak určuje postup implementace a nakonec se zabývá architekturou aplikace. Analysou a návrhem jednotlivých částí aplikace, např. jednotlivých příkazů, datových struktur ap. se pro přehlednost nezabývám v této kapitole, ale až v kapitolách jejich realisace.
