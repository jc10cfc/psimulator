/*
 * Tuhle tridu jsem dne 15.4. zkopiroval z svn archivu z data 7.4.2010
 ...
 */
@Deprecated
public class LinuxIfconfigStarej extends AbstraktniPrikaz {
    ...
    public LinuxIfconfigStarej(AbstractPocitac pc, Konsole kon, List<String> slova) {
        super(pc, kon, slova);
        nastavPrikaz();
        zkontrolujPrikaz();
        vykonejPrikaz();
