...
Když přijde paket do počítače, nejdříve se provede reverzní překlad\footnote{Reverzní překlad by v~češtině nejlépe vystihoval výraz \uv{\textit{odnatování}}.}. Následně počítač dle routovací tabulky rozhodne, na které rozhraní paket odešle. Poté přichází na řadu samotný akt překladu adres. Chování NATu je řízeno několika pravidly:
