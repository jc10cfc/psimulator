...
public class LanguageManagerSingleton extends Observable implements SaveableInterface{
    ...
    private static LanguageManagerSingleton languageManagerSingletonObject;
    
    /** A private Constructor prevents any other class from instantiating. */
    private LanguageManagerSingleton () {
    ...
    public static synchronized LanguageManagerSingleton getSingletonObject() {
        if (languageManagerSingletonObject == null) {
            languageManagerSingletonObject = new LanguageManagerSingleton();
        }
        return languageManagerSingletonObject;
    }
